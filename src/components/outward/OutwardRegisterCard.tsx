...
import { OutwardRegisterItem } from '../../utils/Interfaces';
import { AuthContext } from '../../context/AuthContext';
import { colors } from '../../utils/Colors';

interface OutwardRegisterCardProps {
    item: OutwardRegisterItem;
    handleEditClick: (id: number) => void
    handleDeleteClick: (id: number) => void
}

const OutwardRegisterCard: React.FC<OutwardRegisterCardProps> = ({ item, handleEditClick, handleDeleteClick }) => {
...
export default OutwardRegisterCard
